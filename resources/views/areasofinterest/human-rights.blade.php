...
@section('content')
            ...
            <div class="row h-100">
                ...
                <div class="col-md-5 ml-md-auto align-self-center">
                    <div class="hero text-white py-4">
                        ...
                        <p class="h1">
                            HUMAN RIGHTS
                            <span class="font-weight-lighter">WE STRONGLY SUPPORT</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 ml-auto">
                    <div class="py-3 pl-md-5">
                        <h2 class="h4 text-primary">PROGRAM OVERVIEW</h2>
                        <div class="text-dark">
                            <p>
    ...
    <section class="py-5 bg-white" style="background-image: url({{ asset('images/regions_bg4.png') }});
        background-attachment: fixed;
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 mb-5 pl-0">
                    <!-- Card Narrower -->
                    <div class="card card-cascade h-100 narrower border-0 hero shadow-lg d-flex flex-wrap flex-row">
                        <!-- Card image -->
